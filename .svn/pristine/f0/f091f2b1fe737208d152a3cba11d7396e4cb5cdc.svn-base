...
/**
 * <p>returnMessage complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 ...
 *         &lt;element name="resultList" type="{http://contractchange.construction.webservice.ccccltd.cn/}voSupport" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ReturnMessage {
    ...
    @XmlElement(nillable = true)
    protected List<SgbghtVO> returnInitData= null;


    public List<SgbghtVO> getReturnInitData() {
    	if (returnInitData == null) {
    		returnInitData = new ArrayList<SgbghtVO>();
        }
		return returnInitData;
	}

	public void setReturnInitData(List<SgbghtVO> returnInitData) {
