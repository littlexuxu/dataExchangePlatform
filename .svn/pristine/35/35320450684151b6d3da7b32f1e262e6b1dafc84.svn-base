 ...
 *         &lt;element name="resultList" type="{http://contractchange.other.webservice.ccccltd.cn/}voSupport" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ReturnMessage {
    ...
    @XmlElement(nillable = true)
    protected List<QtbghtVO> returnInitData= null;


    public List<QtbghtVO> getReturnInitData() {
    	if (returnInitData == null) {
    		returnInitData = new ArrayList<QtbghtVO>();
        }
		return returnInitData;
	}

	public void setReturnInitData(List<QtbghtVO> returnInitData) {
