 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://monthreport.other.webservice.ccccltd.cn/}hwxmbxInfo" maxOccurs="unbounded" minOccurs="0"/&gt;
    ...
    extends VoSupport
{
    ...
    @XmlElement(namespace = "http://monthreport.other.webservice.ccccltd.cn/")
