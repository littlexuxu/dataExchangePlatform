 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://projectbaseinfo.design.webservice.ccccltd.cn/}hwxmbxInfo" maxOccurs="unbounded" minOccurs="0"/&gt;
    ...
    extends VoSupport
{
    ...
    @XmlElement(namespace = "http://projectbaseinfo.design.webservice.ccccltd.cn/")
