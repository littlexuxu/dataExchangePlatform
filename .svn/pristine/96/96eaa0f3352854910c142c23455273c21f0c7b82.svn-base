 ...
 *         &lt;element name="resultList" type="{http://contractchange.design.webservice.ccccltd.cn/}voSupport" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ReturnMessage {
    ...
    @XmlElement(nillable = true)
    protected List<SjbghtVO> returnInitData= null;


    public List<SjbghtVO> getReturnInitData() {
    	if (returnInitData == null) {
    		returnInitData = new ArrayList<SjbghtVO>();
        }
		return returnInitData;
	}

	public void setReturnInitData(List<SjbghtVO> returnInitData) {
