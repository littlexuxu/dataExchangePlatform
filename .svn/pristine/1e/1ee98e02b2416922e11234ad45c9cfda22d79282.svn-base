 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://monthreport.construction.webservice.ccccltd.cn/}hwxmbxInfo" maxOccurs="unbounded" minOccurs="0"/&gt;
    ...
    extends VoSupport
{
    ...
    @XmlElement(namespace = "http://monthreport.construction.webservice.ccccltd.cn/")
    protected List<HwxmbxVO> hwxmbxInfo;
    ...
    /**
     * Gets the value of the hwxmbxInfo property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the hwxmbxInfo property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getHwxmbxInfo().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<HwxmbxVO> getHwxmbxInfo() {
        if (hwxmbxInfo == null) {
            hwxmbxInfo = new ArrayList<HwxmbxVO>();
        }
        return this.hwxmbxInfo;
    }
