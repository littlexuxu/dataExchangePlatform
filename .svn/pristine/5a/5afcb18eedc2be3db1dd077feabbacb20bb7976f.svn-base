 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://contract.design.webservice.ccccltd.cn/}otherbidInfo" maxOccurs="unbounded" minOccurs="0"/&gt;
    ...
    extends VoSupport
{
    ...
    @XmlElement(namespace = "http://contract.design.webservice.ccccltd.cn/")
