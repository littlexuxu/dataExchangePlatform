 ...
 *         &lt;element name="resultList" type="{http://contract.design.webservice.ccccltd.cn/}voSupport" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ReturnMessage {
	...
	@XmlElement(nillable = true)
    protected List<SjxmjhtVO> returnInitData= null;
	
	public List<SjxmjhtVO> getReturnInitData() {
    	if (returnInitData == null) {
    		returnInitData = new ArrayList<SjxmjhtVO>();
        }
		return returnInitData;
	}

	public void setReturnInitData(List<SjxmjhtVO> returnInitData) {
