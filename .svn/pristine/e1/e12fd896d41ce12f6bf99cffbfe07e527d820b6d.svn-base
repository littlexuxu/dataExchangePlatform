...
/**
 * <p>ghscxxVO complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 ...
 *         &lt;element name="otherBidList" type="{http://marketinfo.design.webservice.ccccltd.cn/}ghscgzjzbzb" maxOccurs="unbounded" minOccurs="0"/&gt;
    ...
    extends VoSupport
{
    ...
    protected List<Ghscgzjzbzb> otherBidList;
    ...
    /**
     * Gets the value of the otherBidList property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the otherBidList property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getOtherBidList().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Ghscgzjzbzb> getOtherBidList() {
        if (otherBidList == null) {
            otherBidList = new ArrayList<Ghscgzjzbzb>();
        }
        return this.otherBidList;
    }
