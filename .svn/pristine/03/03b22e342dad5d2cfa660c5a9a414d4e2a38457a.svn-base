 ...
 *         &lt;element name="resultList" type="{http://monthreport.other.webservice.ccccltd.cn/}voSupport" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ReturnMessage {
    ...
    @XmlElement(nillable = true)
    protected List<QtxmzxVO> returnInitData= null;
	...
	public List<QtxmzxVO> getReturnInitData() {
		return returnInitData;
	}

	public void setReturnInitData(List<QtxmzxVO> returnInitData) {
