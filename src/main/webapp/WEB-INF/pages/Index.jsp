...
<head>
	...
	<SCRIPT type="text/javascript">
		...
		var zNodes =[
			...
			{ id:13, pId:1, name:"合同变更信息",path:"/construction/listConstructionContractChange"},
			{ id:14, pId:1, name:"执行月报",path:"/construction/listConstructionContractReport"},
			...
			{ id:24, pId:2, name:"执行月报",path:"/design/listDesignContractReport"},
			...
			{ id:33, pId:3, name:"执行月报",path:"/other/listOtherContractReport"},
