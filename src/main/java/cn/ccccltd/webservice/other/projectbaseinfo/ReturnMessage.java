 ...
 *         &lt;element name="resultList" type="{http://projectbaseinfo.other.webservice.ccccltd.cn/}voSupport" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ReturnMessage {
	...
	@XmlElement(nillable = true)
    protected List<QtlxmVO> returnInitData= null;
	
	public List<QtlxmVO> getReturnInitData() {
    	if (returnInitData == null) {
    		returnInitData = new ArrayList<QtlxmVO>();
        }
		return returnInitData;
	}

	public void setReturnInitData(List<QtlxmVO> returnInitData) {
