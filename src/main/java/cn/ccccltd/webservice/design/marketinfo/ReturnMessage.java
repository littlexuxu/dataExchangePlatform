 ...
 *         &lt;element name="resultList" type="{http://marketinfo.design.webservice.ccccltd.cn/}voSupport" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ReturnMessage {
    ...
    @XmlElement(nillable = true)
    protected List<SjscxxVO> returnInitData= null;


    public List<SjscxxVO> getReturnInitData() {
    	if (returnInitData == null) {
    		returnInitData = new ArrayList<SjscxxVO>();
        }
		return returnInitData;
	}

	public void setReturnInitData(List<SjscxxVO> returnInitData) {
