 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://contract.design.webservice.ccccltd.cn/}hwxmbxInfo" maxOccurs="unbounded" minOccurs="0"/&gt;
    ...
    extends VoSupport
{
    ...
    @XmlElement(namespace = "http://contract.design.webservice.ccccltd.cn/", nillable = true)
    protected List<Object> hwxmbxInfo;
     ...
     * 
     */
    public List<Object> getHwxmbxInfo() {
        if (hwxmbxInfo == null) {
            hwxmbxInfo = new ArrayList<Object>();
        }
