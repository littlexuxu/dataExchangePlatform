 ...
 *         &lt;element name="resultList" type="{http://monthreport.design.webservice.ccccltd.cn/}voSupport" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ReturnMessage {
    ...
    @XmlElement(nillable = true)
    protected List<SjxmzxfdVO> returnInitData= null;
	...
	public List<SjxmzxfdVO> getReturnInitData() {
		return returnInitData;
	}

	public void setReturnInitData(List<SjxmzxfdVO> returnInitData) {
