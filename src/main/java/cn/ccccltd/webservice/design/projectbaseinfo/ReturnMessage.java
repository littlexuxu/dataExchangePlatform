 ...
 *         &lt;element name="resultList" type="{http://projectbaseinfo.design.webservice.ccccltd.cn/}voSupport" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ReturnMessage {
	...
	@XmlElement(nillable = true)
    protected List<SjscgzjzbVO> returnInitData= null;
	
	public List<SjscgzjzbVO> getReturnInitData() {
    	if (returnInitData == null) {
    		returnInitData = new ArrayList<SjscgzjzbVO>();
        }
		return returnInitData;
	}

	public void setReturnInitData(List<SjscgzjzbVO> returnInitData) {
