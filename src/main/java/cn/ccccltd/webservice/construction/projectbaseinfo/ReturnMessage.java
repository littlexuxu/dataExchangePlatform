 ...
 *         &lt;element name="resultList" type="{http://projectbaseinfo.construction.webservice.ccccltd.cn/}voSupport" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ReturnMessage {
	...
	@XmlElement(nillable = true)
    protected List<GhscgzjzbVO> returnInitData= null;
	
	public List<GhscgzjzbVO> getReturnInitData() {
    	if (returnInitData == null) {
    		returnInitData = new ArrayList<GhscgzjzbVO>();
        }
		return returnInitData;
	}

	public void setReturnInitData(List<GhscgzjzbVO> returnInitData) {
