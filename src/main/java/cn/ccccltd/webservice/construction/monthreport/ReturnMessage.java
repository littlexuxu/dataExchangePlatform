 ...
 *         &lt;element name="resultList" type="{http://monthreport.construction.webservice.ccccltd.cn/}voSupport" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ReturnMessage {
    ...
    @XmlElement(nillable = true)
    protected List<GhxmzxfdVO> returnInitData= null;
	...
	public List<GhxmzxfdVO> getReturnInitData() {
		return returnInitData;
	}

	public void setReturnInitData(List<GhxmzxfdVO> returnInitData) {
