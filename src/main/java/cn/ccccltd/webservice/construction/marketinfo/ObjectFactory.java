 ...
 * generated in the cn.ccccltd.webservice.construction.marketinfo package. 
...
public class ObjectFactory {
    ...
    private final static QName _AddMarketInfo_QNAME = new QName("http://marketinfo.construction.webservice.ccccltd.cn/", "addMarketInfo");
    private final static QName _AddMarketInfoResponse_QNAME = new QName("http://marketinfo.construction.webservice.ccccltd.cn/", "addMarketInfoResponse");
    private final static QName _QueryMarketInfoById_QNAME = new QName("http://marketinfo.construction.webservice.ccccltd.cn/", "queryMarketInfoById");
    private final static QName _QueryMarketInfoByIdResponse_QNAME = new QName("http://marketinfo.construction.webservice.ccccltd.cn/", "queryMarketInfoByIdResponse");
    private final static QName _UpdateMarketInfo_QNAME = new QName("http://marketinfo.construction.webservice.ccccltd.cn/", "updateMarketInfo");
    private final static QName _UpdateMarketInfoResponse_QNAME = new QName("http://marketinfo.construction.webservice.ccccltd.cn/", "updateMarketInfoResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.ccccltd.webservice.construction.marketinfo
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://marketinfo.construction.webservice.ccccltd.cn/", name = "addMarketInfo")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://marketinfo.construction.webservice.ccccltd.cn/", name = "addMarketInfoResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://marketinfo.construction.webservice.ccccltd.cn/", name = "queryMarketInfoById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://marketinfo.construction.webservice.ccccltd.cn/", name = "queryMarketInfoByIdResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://marketinfo.construction.webservice.ccccltd.cn/", name = "updateMarketInfo")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://marketinfo.construction.webservice.ccccltd.cn/", name = "updateMarketInfoResponse")
