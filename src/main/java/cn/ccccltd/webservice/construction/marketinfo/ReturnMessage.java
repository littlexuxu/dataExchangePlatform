 ...
 *         &lt;element name="resultList" type="{http://marketinfo.construction.webservice.ccccltd.cn/}voSupport" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class ReturnMessage {
    ...
    @XmlElement(nillable = true)
    protected List<GhscxxVO> returnInitData= null;


    public List<GhscxxVO> getReturnInitData() {
    	if (returnInitData == null) {
    		returnInitData = new ArrayList<GhscxxVO>();
        }
		return returnInitData;
	}

	public void setReturnInitData(List<GhscxxVO> returnInitData) {
