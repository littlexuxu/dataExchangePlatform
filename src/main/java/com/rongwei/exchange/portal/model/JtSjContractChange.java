...
/**
 * The persistent class for the jt_sj_contract_change database table.
 * 
 */
@Entity
@Table(name="jt_sj_contract_change")
@NamedQuery(name="JtSjContractChange.findAll", query="SELECT j FROM JtSjContractChange j")
public class JtSjContractChange implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	private int sjchangeid;
	...
	public JtSjContractChange() {
	}

	public int getSjchangeid() {
		return this.sjchangeid;
	}

	public void setSjchangeid(int sjchangeid) {
		this.sjchangeid = sjchangeid;
	}
